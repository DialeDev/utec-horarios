      ...
      <div className="max-w-2xl w-full space-y-8 text-center">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          ...
          <div className="bg-white rounded-xl shadow-lg border border-slate-200 p-6 hover:shadow-xl transition-shadow">
            ...
            <label className="inline-flex items-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-lg cursor-pointer hover:bg-blue-700 transition-colors font-medium">
        ...
        <div className="text-sm text-slate-400">
          <p>💡 Tip: Puedes personalizar los colores de exportación en el builder</p>
        </div>
      </div>
    </div>
  );
